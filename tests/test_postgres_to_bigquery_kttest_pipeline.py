"""Automated tests for pipeline postgres_to_bigquery_kttest."""
import ast
import os
import pytest
...
def test_dag_syntax():
    ...
    dag_path = os.path.join("dags", "postgres_to_bigquery_kttest_dag.py")
...
def test_standalone_script_syntax():
    ...
    script_path = os.path.join("pipeline", "run_postgres_to_bigquery_kttest.py")
