"""Automated tests for pipeline gcs_to_bigquery_analytics."""
import ast
import os
import pytest
...
def test_dag_syntax():
    ...
    dag_path = os.path.join("dags", "gcs_to_bigquery_analytics_dag.py")
...
def test_standalone_script_syntax():
    ...
    script_path = os.path.join("pipeline", "run_gcs_to_bigquery_analytics.py")
