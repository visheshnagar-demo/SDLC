...
def _extract_gcs_to_staging(**context):
    ...
    # Staging destination path: gs://sdlc-data-staging-sales_etl/staging/sales_etl/date={{ ds }}/data.parquet
    logger.info("Source config: extraction_mode=full, cursor=None")
    return {
        "source": "gcs",
        "staging_path": f"gs://sdlc-data-staging-sales_etl/staging/sales_etl/date={execution_date}/data.parquet",
