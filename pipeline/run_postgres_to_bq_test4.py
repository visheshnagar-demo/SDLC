...
class PipelineRunner:
    ...
    def extract(self) -> int:
        ...
        if instance_connection_name and not db_url:
            ...
            ip_type_val = IPTypes.PRIVATE if ip_type_str == "PRIVATE" else IPTypes.PUBLIC
            logger.info(
                "Connecting via Google Cloud SQL Connector for instance %s with IAM Auth (db=%s, user=%s, ip_type=%s)",
                instance_connection_name, dbname, user, ip_type_str
            )
