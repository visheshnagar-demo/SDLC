...
class PipelineRunner:
    ...
    def load(self) -> bool:
        ...
        schema_file = None
        for cand in [
            os.path.join("schemas", f"vishesh-test1_schema.json"),
            os.path.join("schemas", f"sales_order_etl_schema.json"),
        ...
        if schema_file:
            ...
            except (ValueError, json.JSONDecodeError, OSError) as schema_err:
...
if __name__ == "__main__":
    ...
    try:
        ...
        logging.getLogger("sales_order_etl").critical("Pipeline failed with unhandled error: %s", exc, exc_info=True)
        sys.exit(1)
