"""Standalone Connector Pipeline: postgres_to_bigquery_sales_etl
...
logger = logging.getLogger("postgres_to_bigquery_sales_etl")
...
class SalesDataCleanser:
    ...
    def clean_records(self, data: Any) -> Any:
        ...
        # Convert input to list of dicts for standardized iteration
...
class PipelineRunner:
    ...
    def __init__(self, execution_date: str = None, source_table: str = "raw_sales_orders", target_dataset: str = "dev_sales", target_table: str = "fct_sales_orders_v1"):
        ...
        self.staging_dir = os.path.join("staging", "postgres_to_bigquery_sales_etl", self.execution_date)
    ...
    def run(self) -> int:
        ...
        logger.info("=== Starting PostgreSQL to BigQuery Sales ETL Pipeline [%s] ===", self.execution_date)
        try:
            # 1. Extraction
